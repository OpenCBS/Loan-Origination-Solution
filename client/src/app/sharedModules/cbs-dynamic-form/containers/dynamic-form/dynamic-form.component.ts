...
export class DynamicFormComponent implements OnChanges, OnInit {
    ...
    ngOnChanges() {
        if (this.form) {
            ...
            const configControls: any = this.controls.map((item) => item.code);
            ...
            configControls
                ...
                .forEach((name) => {
                    const config = this.config.find((control) => control.code === name);
    ...
    createGroup() {
        ...
        this.controls.forEach(control => group.addControl(control.code, this.createControl(control)));
        return group;
    }
